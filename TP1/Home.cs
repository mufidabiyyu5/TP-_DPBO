...
namespace TP1
{
    public partial class Home : Form
    {
        ...
        {
            //set barangnya
            this.dataItem.Add(new Items("PS4", "Elektronik", 700000, 0, "75-758657_ps4-transparent-png-playstation-4-pro-slim-png"));
            this.dataItem.Add(new Items("Seblak Sultan", "Makanan", 500000, 1, "seblak"));
            this.dataItem.Add(new Items("Baju Raja", "Pakaian", 800000, 2, "baju-raja"));
            this.dataItem.Add(new Items("Coklat Emas", "Makanan", 600000, 3, "coklat-emas"));
            this.dataItem.Add(new Items("Kaos Kaki Supreme", "Pakaian", 900000, 4, "kaos-kaki-supreme"));
        }
        ...
        void viewBarang()
        {
            ...
            foreach(var data in this.dataItem)
            {
                ...
                if(data.jenis == this.jenis)
                {
                    ...
                    {
                        panel3.Controls.Add(createBox(data.nama, data.harga, data.id, data.gambar));
        ...
        Panel createBox(string nama, int harga, int id, string gambar)
        {
            //membuat box-box / panel untuk barang2
            Panel panelItems = new Panel();

            PictureBox img = createImg(gambar);
        ...
        PictureBox createImg(string gambar)
        {
            //membuat picture box
            PictureBox imgItem = new PictureBox();

            imgItem.Image = (Image)Properties.Resources.ResourceManager.GetObject(gambar);
